...
class soapclientNusoap extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclientNusoap($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class nusoap_proxy_'.$r.' extends soapclientNusoap {
	'.$evalStr.'
}';
		return $evalStr;
	}
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends soapclientNusoap {
	}
}
?>